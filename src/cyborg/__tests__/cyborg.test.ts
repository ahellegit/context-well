// Tests for the CyborgDB wrapper. The cyborgdb-service is not running in
...
// IndexLockedError classification, the dimension guard, and that upsert sends
...
describe("upsertChunks", () => {
  it("sends contents + metadata, never a vector", async () => {
    ...
    // No precomputed vector is ever sent — the service embeds.
