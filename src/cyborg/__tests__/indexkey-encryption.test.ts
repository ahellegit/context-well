// The critical fix. Space.indexKey is the CyborgDB per-space encryption key;
// it must be ciphertext at rest so a stolen app.db can't decrypt the embeddings.
// Read through prisma it decrypts to hex, and hexToKey() converts it for
...
describe("Space.indexKey encryption", () => {
