// Sync orchestration tests. The CyborgDB index-service is fully mocked with
...
describe("connectorsRoutes credential masking", () => {
  ...
  beforeEach(async () => {
    ...
    // passes the route guards so this test can assert credential masking.
  ...
  it("masks credentials to {set,last4} in the list route", async () => {
