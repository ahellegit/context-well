// Auth integration tests. Spins a real Fastify app wired like src/server.ts
...
describe("credential edge cases", () => {
  it("rejects a duplicate email at the service layer (409 path)", async () => {
    ...
    // service directly — the admin Members flow reuses this guard.
...
describe("registration is bootstrap-only", () => {
