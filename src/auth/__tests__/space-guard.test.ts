// Authorization-layer tests. Isolates authz from authn: instead of the
...
// CyborgDB is mocked so no service is needed. Covers default-deny.
...
describe("space list + cross-space route isolation", () => {
...
describe("viewer cannot write, editor can", () => {
...
describe("default-deny with no existence oracle", () => {
  ...
  it("IDOR: a conversation/connector in B is 403, indistinguishable from a bogus id", async () => {
    currentUser = asUser(alice, "member");
