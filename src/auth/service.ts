// Auth service: password hashing, login verification, and server-side
...
// hashed with argon2id (argon2 defaults).
...
/** True when no users exist yet — the first registration bootstraps the operator. */
...
export async function register(email: string, password: string): Promise<AuthUser> {
  ...
  // The first account ever created is the workspace owner. Defensive
